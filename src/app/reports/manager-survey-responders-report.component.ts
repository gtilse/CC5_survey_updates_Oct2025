...
@Component({
  selector: 'manager-survey-responders-report',
  template: `
    <div
      class="mat-table report"
      matSort
      (matSortChange)="sortData($event)"
      matSortActive="managerName"
    ...
    >
      <div class="mat-header-row">
        <div
          ...
          mat-sort-header="managerName"
          flex="20"
        >
          Manager
        </div>
        <div class="mat-header-cell" mat-sort-header="department" flex="25">
          Department
        </div>
        <div class="mat-header-cell" mat-sort-header="designation" flex="25">
          Designation
        </div>
        <div class="mat-header-cell" flex="15">Received On</div>
      ...
      <div *ngFor="let survey of sortedData">
        ...
        <div *ngFor="let log of survey.log">
          ...
          <div class="mat-row small" *ngFor="let item of log.data">
            <div class="mat-cell" flex="20">{{ item.managerName }}</div>
            <div class="mat-cell" flex="25">{{ item.department }}</div>
            <div class="mat-cell" flex="25">{{ item.designation }}</div>
...
export class ManagerSurveyRespondersReportComponent
