...
@Component({
  selector: 'manager-survey-status-report',
  template: `
    <div
      class="mat-table report"
      matSort
      (matSortChange)="sortData($event)"
      matSortActive="staffName"
      matSortDirection="asc"
      matSortDisableClear
      [hidden]="data.length === 0"
    >
      <div class="mat-header-row">
        <div class="mat-header-cell" mat-sort-header="staffName" flex="20">
          Staff
        </div>
        <div class="mat-header-cell" mat-sort-header="staffEmail" flex="20">
          Email
        </div>
        <div class="mat-header-cell" flex="10">Email Status</div>
        <div class="mat-header-cell" flex="10">Opened</div>
        <div class="mat-header-cell" flex="20">Reminder Date</div>
        <div class="mat-header-cell" flex="20">Reminder Status</div>
      </div>
      ...
      <div *ngFor="let survey of sortedData">
        ...
        <div *ngFor="let log of survey.log">
          ...
          <div class="mat-row small" *ngFor="let item of log.data">
            <div class="mat-cell" flex="20">{{ item.staffName }}</div>
            <div class="mat-cell" flex="20">{{ item.staffEmail }}</div>
...
export class ManagerSurveyStatusReportComponent implements OnInit, OnChanges {
