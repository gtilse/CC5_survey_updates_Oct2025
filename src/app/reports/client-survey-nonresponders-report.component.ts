...
@Component({
  selector: 'client-survey-nonresponders-report',
  template: `
    <div
    ...
    >
      <div class="mat-header-row">
        ...
        <div class="mat-header-cell" flex="10">Phone</div>
        <div class="mat-header-cell" flex="10">Organisation</div>
        <div class="mat-header-cell" flex="10">Client Contact</div>
        <div class="mat-header-cell" flex="10">Email Status</div>
        <div class="mat-header-cell" flex="5">Opened</div>
        <div class="mat-header-cell" flex="10">Reminder Date</div>
        <div class="mat-header-cell" flex="10">Reminder Status</div>
      </div>
      ...
      <div *ngFor="let survey of sortedData">
        ...
        <div *ngFor="let log of survey.log">
          ...
          <div class="mat-row small" *ngFor="let item of log.data">
            ...
            <div class="mat-cell" flex="10">{{ item.clientContact }}</div>
            ...
            <div class="mat-cell" flex="10">
              {{ item.reminderDate | utcToLocal: 'MMM YY' }}
            </div>
            <div class="mat-cell" flex="10">
              {{
...
export class ClientSurveyNonRespondersReportComponent
